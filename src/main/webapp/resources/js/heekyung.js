...
hee.rev = (function(){
	...
	var onCreate=function(hs){
		...
		$.getScript(temp,()=>{
			...
			hee.logic.revdata(hostSerial);
			hee.logic.revDetail(hostSerial);
			hee.logic.datePic(hostSerial);
			hee.logic.reviewSearch(hostSerial);
