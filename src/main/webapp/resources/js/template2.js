...
/*main navbar*/
navbar:()=>{return '<!--네비바-->'
+'	<header id="main-navbar" class="headroom">'
...
+'	            <input id="mainSearchWord" type="text" class="form-control" aria-describedby="sizing-addon1">'
